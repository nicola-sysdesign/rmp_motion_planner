...
int main(int argc, char* argv[])
{
  ...
  auto planning_component = std::make_shared<moveit::planning_interface::PlanningComponent>(planning_group_name, moveit_cpp);


  /* RMP PLANNER */
  rmp::MotionPlanner rmp_motion_planner(robot_model, planning_component, node);
  ...
  // Published Topics
  auto joint_group_pos_cmd_pub = node.advertise<std_msgs::Float64MultiArray>("/panda/joint_group_position_controller/command", 1);
